...
import { Search, Droplet, Clock, Shield, Star, Filter, ShoppingCart, Plus } from "lucide-react";
...
const BloodTest = () => {
  ...
  const [bookingItem, setBookingItem] = useState<{ name: string; price: string } | null>(null);
  ...
  const handleBookNow = (test: any) => {
    setBookingItem({ name: test.name, price: test.price });
  };
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  className="border border-input rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-medical-blue"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="text-center p-6">
              ...
              <p className="text-muted-foreground text-sm">All tests performed in NABL accredited laboratories</p>
            </Card>

            <Card className="text-center p-6">
              <Clock className="w-12 h-12 text-medical-blue mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">Fast Results</h3>
              <p className="text-muted-foreground text-sm">Get your reports within 6-24 hours</p>
            </Card>

            <Card className="text-center p-6">
              <Droplet className="w-12 h-12 text-medical-blue mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">Home Collection</h3>
              <p className="text-muted-foreground text-sm">Free home sample collection service available</p>
            </Card>

            <Card className="text-center p-6">
              <Star className="w-12 h-12 text-medical-blue mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">Expert Analysis</h3>
              <p className="text-muted-foreground text-sm">Reports reviewed by experienced pathologists</p>
            </Card>
          </div>
        </div>
      </section>
